...
// ── 1) BOŞ fixture: hiç zikir verisi yok ──
{
  ...
  ok('Boş fixture: zikr root otomatik oluşur, schemaVersion=4', data.zikr && data.zikr.schemaVersion === 4);
...
// ── 2) V1 fixture: eski düz sayı formatı, hiç schemaVersion/migrationVersion/journeys yok ──
{
  ...
  ok('V1 fixture: schemaVersion=4, migrationVersion=zikr_v2', data.zikr.schemaVersion === 4 && data.zikr.migrationVersion === 'zikr_v2');
...
// ── 3) V2 fixture: zaten tam V2 şeması (journeys/hatims dolu) — V3 yalnız EKLEME yapmalı ──
{
  ...
  ok('V2 fixture: schemaVersion 2 → 4', data.zikr.schemaVersion === 4);
