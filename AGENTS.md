...
- **İlham & İbadet Premium (IIP)** — [`ilham-ibadet-premium-plan/`](ilham-ibadet-premium-plan/README.md) — 24 kartlık hub yenileme programı. **🏁 KAPANDI (2026-09-22): 24/24 kart + P00–P17 düzeltmeleri tamamlandı, kalan iş YOK.** Kapanış: [`docs/IIP-KAPANIS.md`](docs/IIP-KAPANIS.md); durum [`IIP-STATE.json`](ilham-ibadet-premium-plan/IIP-STATE.json) (`nextExecutableCard: null`). Ölçüm: **156 fixture PASS / 0 FAIL**,
...
**Klasör taşınmadı** (taşıma **20 makbuz dizinini / 41 dosyayı** + `test_iip_17.js` yazma
yolunu kırar; 2026-09-23'te ölçümle yeniden doğrulandı). Yeni bir IIP işi ayrı kapsam onayı ister.
