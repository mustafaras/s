...
app/core/reminder*.js  Frozen REM program modules (`ReminderCatalogV1`,
                 ...
                 reminderCatalog.js.
app.js           The Şeyma runtime (single IIFE, ~17.8k lines). Still the owner
