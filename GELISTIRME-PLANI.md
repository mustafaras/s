...
|-----|--------|---------|-------|--------|
| 35 | 🎯 Zikirmatik — sayaç + preset + günlük kayıt | 1 | ✅ | `data.zikr` + `data.days[].zikr`; overlay, ses/haptic/otomatik ilerleme; 5 temel + 99 Esmâ preset, asıl-ebced hedefli geri sayım; panel bento kart |
