...
> - **2026-07-20:** **Terapi Odası Premium Genişletme — Bilimsel Profil** canlı (branch'ta): İçsel Pusula → Terapi Odası overlay'i **Yol / Araçlar / Profilim** 3 sekmesine ayrıldı. Yol sekmesinde Bugünün Kazanımları + Esneklik Nudgesı; Araçlar sekmesinde İlk Adım, Öz-Şefkat, Rehberli Nefes (4-7-8 / kutu), Karar Hızlandırıcı, CBT Düşünce Kaydı, Güvenli Paylaşım (ÆON sinyali); Profilim sekmesinde `seyma-data` reposundaki bilimsel profil raporu çekilip RIASEC/değer rozetleri, güçlü yönler/riskler ve panel için gözlemci rehberi gösteriliyor. Veri modeli: `data.scientificProfile` + `data.days[].therapy`; panelde "Bilimsel Profil Işığı" bento kartı + gün-detay Terapi Odası satırları. Cache bump `20260720a`.
