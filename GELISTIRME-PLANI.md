...
|-----|--------|---------|-------|--------|
| 35 | 🎯 Zikirmatik v2 — kalıcı yolculuk + Ebced² Tam Hatim | 1 | ✅ | `schemaVersion:2`; 100dvh bağımsız ekran; 5 temel + 99 Esmâ; ebced turu ve ebced² hatim; Hatimlerim, reload/preset/gün devamı, idempotent migration, erişilebilir ayarlar, ayrıntılı panel ve monotonik sync |
