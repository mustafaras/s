...
|-----|---------------|---------|-------|------------------------------|----------------|
| 42 | ✨ **Kozmetik Premium** — glass/glow/shimmer kaplama + 5. sekme Rapor polisajı + tüm hub mikro-premium'u | 1 | ✅ | Veri/işlev değişmez; glass kart stilleri, accent gradient'lar, zikir/iman/öncü/rapor yüzeyleri | Cache `20260730j` |
| 35 | 🎯 **Zikirmatik** — sayaç + preset + günlük kayıt | 1 | ✅ | Sayaç/preset/stats; 5 temel + 99 Esmâ; Arapça yazımdan asıl-ebced hedefi ve geri sayım; çoklu set, ses+haptic | Panel zikir özeti; cache `20260730j` |
