...
window.addEventListener('visibilitychange',function(){
  ...
  else { resetSession(); if(data&&data.settings&&data.settings.locationEnabled&&moveState.watchId==null) startLocationWatch(false); }
});
updateLiveSession();
