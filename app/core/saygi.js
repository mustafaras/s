...
function faithCornerOverlayHTML(){
  ...
  function iip17ReaderHTML(date,catalog){
    ...
    return '<article class="iip17-reader" aria-labelledby="iip17-title">'+
      ...
      '<section class="iip17-text-block iip17-reading-block" aria-labelledby="iip17-reading-label"><h4 id="iip17-reading-label">Okunuş</h4><p lang="tr" dir="ltr">'+(v.transliterationTr?escHtml(v.transliterationTr):'Bu kayıt için onaylı Latin harfli okunuş bulunmuyor.')+'</p></section>'+
  ...
  function iip21DaySummaryHTML(p,day){
    ...
    return '<article class="iip21-day" aria-labelledby="iip21-day-'+day+'">'+
      ...
      '<div class="iip21-translation-grid"><section class="iip21-reading" aria-labelledby="iip21-reading-'+day+'"><h5 id="iip21-reading-'+day+'"><span aria-hidden="true">01</span> Okunuş</h5><p class="iip21-transliteration" lang="tr" dir="ltr">'+escHtml(v.transliterationTr||'Bu kayıt için onaylı Latin harfli okunuş bulunmuyor.')+'</p></section>'+
      '<section class="iip21-meaning" aria-labelledby="iip21-meaning-'+day+'"><h5 id="iip21-meaning-'+day+'"><span aria-hidden="true">02</span> Anlam</h5><p lang="tr" dir="ltr">'+escHtml(v.meal)+'</p></section></div>'+
