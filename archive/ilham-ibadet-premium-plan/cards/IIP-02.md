...
**Paket:** A · **Rol:** design · **Boyut:** L · **Durum:** yalnız [IIP-STATE.json](../IIP-STATE.json) üzerinden okunur.
...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-02** bölümü. Normal oturumda `session-brief.mjs IIP-02` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.
...
Plan artifactleri: `evidence/IIP-02/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-003 / TC-003 — Özgün görsel yön

12 ekranın ana varyantları; ışık/koyu ve büyük yazı için görsel referans üretilecek.

Olumsuz kontrol: Sadece güzel hero olup hata/okuyucu/kayıt ekranı tasarlanmamışsa kabul yok.

### REQ-004 / TC-004 — Bileşen/token eşlemesi

Her bileşenin renk/font/boşluk/radius/hareket rolü mevcut tokena veya gerekçeli öneriye bağlı.

Olumsuz kontrol: Hardcoded renk, değişik ikon dili ve ölçülmemiş kontrast listede açık kalır.
<!-- CONTRACT:END -->
