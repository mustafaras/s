...
**Paket:** A · **Rol:** reviewer · **Boyut:** M · **Durum:** yalnız [IIP-STATE.json](../IIP-STATE.json) üzerinden okunur.
...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-08** bölümü. Normal oturumda `session-brief.mjs IIP-08` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.

<!-- CONTRACT:START -->
## Yürütme sözleşmesi — üretilmiş

**Bağımlılıklar:** IIP-05, IIP-06, IIP-07.

**Rol:** reviewer · **Kararlar:** yok.
...
Plan artifactleri: `evidence/IIP-08/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-015 / TC-015 — A paketi işlev kabulü

İlgili dar testler, VM, syntax, bütçe ve diff kanıtı dosyalanır.

Olumsuz kontrol: Bir FAIL varken A kabulü kapanmaz; fixture pinleri gerekçesiz güncellenmez.

### REQ-016 / TC-016 — A paketi görsel kabulü

Planlanan ekran matrisi gerçek render üzerinde incelenir; cihaz kanıtı ayrı tutulur.

Olumsuz kontrol: VM PASS ekran görüntüsü veya cihaz kabulü diye etiketlenmez.
<!-- CONTRACT:END -->
