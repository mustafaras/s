...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-09** bölümü. Normal oturumda `session-brief.mjs IIP-09` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.

<!-- CONTRACT:START -->
## Yürütme sözleşmesi — üretilmiş

**Bağımlılıklar:** IIP-08.

**Rol:** frontend · **Kararlar:** DEC-02.

**Üretim allowlist:** `app/core/saygi.js`, `app/core/render.js`, `app.js`, `app/styles.css`.

**Test allowlist:** `tests/app/test_saygi_boundary.js`, `tests/app/test_iip_09.js`.

**Gerekli gate:** scope, requirements, review, source, visual. **Veri etkili yazıcı:** false.

Plan artifactleri: `evidence/IIP-09/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-017 / TC-017 — Beş bölüm hedef mimarisi

Bugün/İlham/İbadet/Zikir/Ritim; Kur’an ve kıble hedefleri en çok iki dokunuş.

Olumsuz kontrol: Eski deep-link ve dönüş bağlamı aynı hedefe gider; hiçbir işlev kaybolmaz.

### REQ-018 / TC-018 — Geri dönüş bağlamı

Modal kapanınca açan kontrol, seçili sekme ve scroll korunur.

Olumsuz kontrol: Hızlı aç/kapa ve tarayıcı geri hareketi çift modal veya boş kabuk üretmez.
<!-- CONTRACT:END -->
