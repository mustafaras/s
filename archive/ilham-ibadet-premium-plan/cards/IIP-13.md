...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-13** bölümü. Normal oturumda `session-brief.mjs IIP-13` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.

<!-- CONTRACT:START -->
## Yürütme sözleşmesi — üretilmiş

**Bağımlılıklar:** IIP-03, IIP-09.

**Rol:** domain · **Kararlar:** yok.
...
Plan artifactleri: `evidence/IIP-13/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-025 / TC-025 — Vakit tazeliği

Tarih/şehir/yöntem eşleşmeyen cache açıkça eski olarak gösterilir.

Olumsuz kontrol: Gece yarısı, şehir değişimi, timeout ve yöntem değişimi sahte güncel saat üretmez.

### REQ-026 / TC-026 — Saat dilimi sınırı

Türkiye kapsamı açık; seyahat için otomatik destek iddiası yok.

Olumsuz kontrol: GPS yurtdışında olsa bile Istanbul saati yerel saat diye sunulmaz.
<!-- CONTRACT:END -->
