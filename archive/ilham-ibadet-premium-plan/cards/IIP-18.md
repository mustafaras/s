...
**Paket:** B · **Rol:** reviewer · **Boyut:** M · **Durum:** yalnız [IIP-STATE.json](../IIP-STATE.json) üzerinden okunur.
...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-18** bölümü. Normal oturumda `session-brief.mjs IIP-18` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.

<!-- CONTRACT:START -->
## Yürütme sözleşmesi — üretilmiş

**Bağımlılıklar:** IIP-11, IIP-12, IIP-13, IIP-14, IIP-15, IIP-17.
...
Plan artifactleri: `evidence/IIP-18/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-035 / TC-035 — B paket kabulü

Akış, rapor, kaynak ve panel kanıtı birlikte incelenir.

Olumsuz kontrol: 14–19 arasında koşullu bağımlılık döngüsü veya gizli migration bulunmaz.

### REQ-036 / TC-036 — İçerik yayın güveni

Pilot lisans/uzman incelemesi ve erişilebilirliği tamamlanmadan ürün yayını yok.

Olumsuz kontrol: Taslak içerik üretimi yayın onayı diye işaretlenmez.
<!-- CONTRACT:END -->
