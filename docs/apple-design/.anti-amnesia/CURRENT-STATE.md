...
| **Durum** | `in_progress` |
| **Aktif prompt** | yok |
| **Son tamamlanan** | `AD-11` — --listen metin taşındı |
| **Sıradaki** | `AD-12` |
| **Güncel dalga** | `2` |
| **Bloke** | yok |
| **Son güncelleme** | 2026-08-23 |

**Uygulanan promptlar:** AD-01 … AD-11. Her biri kendi commit'inde; `git revert <commit>` ile tek tek geri alinabilir (I6).
...
Bulgular 52 sıralı prompta dönüştürüldü; 11 tanesi uygulandı.
