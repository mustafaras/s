...
| **Durum** | `in_progress` |
| **Aktif prompt** | yok |
| **Son tamamlanan** | `AD-04` — forced-colors güvenlik ağı |
| **Sıradaki** | `AD-05` |
| **Güncel dalga** | `1` |
| **Bloke** | yok |
| **Son güncelleme** | 2026-08-23 |

**Uygulanan promptlar:** AD-01 … AD-04. Her biri kendi commit'inde; `git revert <commit>` ile tek tek geri alinabilir (I6).
...
Bulgular 52 sıralı prompta dönüştürüldü; 4 tanesi uygulandı.
