...
| 34 | `app.js:16364` | `App.closeTitleEdit` | evet | `role` |
| 35 | `app.js:16364` | `event.stopPropagation` | evet | `role` |
| 36 | `app.js:16372` | `App.closeReplicaAdd` | evet | `role` |
| 37 | `app.js:16372` | `event.stopPropagation` | evet | `role` |
| 38 | `app.js:16476` | `App.closeTrackEdit` | evet | `role` |
| 39 | `app.js:16476` | `event.stopPropagation` | evet | `role` |
| 40 | `app.js:16484` | `App.closeLyricAdd` | evet | `role` |
| 41 | `app.js:16484` | `event.stopPropagation` | evet | `role` |
