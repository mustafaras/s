...
| REM-28 | R8 | Full regression, migration ve time matrix | `in-progress` | — | — | G8 ön koşulu; full regression, migration, deterministic time ve privacy matrix çalıştırılıyor |
