...
| REM-39 | R9 | Retention, export, clear ve reset lifecycle | `done` | `dba9379f274032cb209c44854056813d5fd48a47` | `evidence/REM-39.md`; retention 58, privacy 58, migration 50 assertion; delivery 38, center advanced 48, concurrency 38, sync privacy 97; driver, context, syntax ve diff PASS | G9-J kapandı; ayrı preference/occurrence/delivery/action/digest retention, clear boundary+tombstone no-replay, confirmation + undo, aggregate privacy-safe export ve reminder-only full reset tamamlandı; `REM-40` ready; S5 pending; release `not_approved`, push/merge/Pages/deploy/device acceptance yok |
