...
| REM-04 | R1 | Preference state + additive migration | `done` | `87b64ec` | `evidence/REM-04.md`; migration 5 case / 50 assertion; privacy 2 case / 19 assertion; B2 32/32; driver, syntax ve diff PASS | Blocker yok; sync.js reminder-specific sanitize/merge REM-25’e açık; `activePrompt=REM-05`; push/merge/deploy yok |
