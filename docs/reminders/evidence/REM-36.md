...
snooze/mute, history, preview ve action etiketleri aynı helper üzerinden
okunuyor.
...
- `app.js`: canonical helper kullanımı, generic native preview sınırı,
  permission/status/digest/inbox/center/history/medication copy bağlantıları,
  settings entry ve action labels.
...
- `tests/reminders/test_reminder_copy.js`: lexicon completeness, immutable
  lookup, canonical surface integration, negative language, native leakage
  ve long-copy wrap assertions.
...
| Katman | Komut | Sonuç |
|---|---|---|
| Copy / negative / native privacy / wrap | `node tests/reminders/test_reminder_copy.js` | PASS — 793 assertions |
...
- S2: copy 793, privacy 35, accessibility 136, catalog 423, native 66,
  center 48, inbox 40 ve final full reminder fixture loop PASS.
- S3: implementation commits `7517b91d0c9c425c66f1ed2a0638f83d90d798f2` and
  `0ecf6e05064891b877b6ea12ad8c52067fa78ef8`; the latter closes the remaining
  hardcoded reminder copy surfaces found by the completion audit.
