...
- Fixture: `tests/app/test_v3_welcome.js` → **287 kontrol, PASS** (2026-09-15 Claude denetimi: 263 → 287; veri artık `v3-snapshot.js` ile statik — bkz. README §Statik anlık görüntü)
...
# Ana fixture (287 kontrol) — bu sayfanın sözleşmesi
...
`test_v3_welcome 287 kontrol PASS`
...
- [ ] `node tests/app/test_v3_welcome.js` → **PASS** (≥287 kontrol)
