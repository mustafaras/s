...
**Paket:** B · **Rol:** reader · **Boyut:** L · **Durum:** yalnız [IIP-STATE.json](../IIP-STATE.json) üzerinden okunur.
...
Görev metninin tek kaynağı: [UYGULAMA-PROMPTLARI.md](../UYGULAMA-PROMPTLARI.md), **IIP-11** bölümü. Normal oturumda `session-brief.mjs IIP-11` bu bölümü ve aşağıdaki canlı sözleşmeyi birlikte verir; kartın tamamını ayrıca okumak gerekmez.

<!-- CONTRACT:START -->
## Yürütme sözleşmesi — üretilmiş

**Bağımlılıklar:** IIP-10.
...
Plan artifactleri: `evidence/IIP-11/`. State/ledger tek yazarı integratör. Allowlist dışı üretim değişimi ve canlı veri yazımı yok. Yeni dosya ihtiyacı kapsam kaydıyla çözülür; var olan yetki tekrar sorulmaz.

### REQ-021 / TC-021 — Okuyucu kontrolü

Oturumluk Aa, bölüm atlama ve konum koruma; varsayılana dönme var.

Olumsuz kontrol: Büyütme sırasında metin ankrajı kaybolmaz; RTL ayrı dil yönü taşır.

### REQ-022 / TC-022 — Okuma beyanı

Mevcut gate A’da korunur; B’de erişilebilir alternatif açık ürün kararıyla eklenir.

Olumsuz kontrol: Kaydırma/ekran okuyucu erişimi otomatik okudum kaydı oluşturmaz.
<!-- CONTRACT:END -->
