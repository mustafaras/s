...
const M = [
  ...
  { id: 'M08 02§1 L2 yön: hep ar>tr', file: QL, from: "var direction=index%2?'tr>ar':'ar>tr';", to: "var direction='ar>tr';", tests: ['tests/kao/test_kao_queue.js', 'tests/kao/test_kao_requirements.js'] },
  ...
  { id: 'M10 02§3 "bilinen"=review∧s≥21 (plan tanımına çevir)', file: QL, from: "(nonNegativeNumber(card.reps,0)>0||card.state==='review'||card.st==='review')", to: "((card.state==='review'||card.st==='review')&&nonNegativeNumber(card.s,0)>=21)", tests: ['tests/kao/test_kao_requirements.js', 'tests/kao/test_kao_render.js', 'tests/kao/test_kao_panel_projection.js', 'tests/kao/test_kao_user_tasks.js'] },
