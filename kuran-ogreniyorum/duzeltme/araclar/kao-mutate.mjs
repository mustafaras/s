...
const M = [
  ...
  { id: 'M10 02§3 eski sapma: bilinen = reps>0 (FIX-07 ters çevrildi)', file: QL, from: "return (card.state==='review'||card.st==='review')&&nonNegativeNumber(card.s,0)>=21&&card.orphan!==true", to: "return (nonNegativeNumber(card.reps,0)>0||card.state==='review'||card.st==='review')&&card.orphan!==true", tests: ['tests/kao/test_kao_requirements.js', 'tests/kao/test_kao_render.js', 'tests/kao/test_kao_panel_projection.js'] },
