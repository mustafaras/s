...
**Tarih:** 2026-09-26 · **HEAD:** `be4a2a8` · **Kapsam:** KAO-18, KAO-19, KAO-20 · **Sonuç:** `pass` · **Kod değişikliği:** yok

## Denetim maddeleri

| # | Madde | Durum | Kanıt |
|---|---|---|---|
| 1 | Kart kontrolleri bugünkü kodda yeniden çalıştırıldı | ✓ | KAO-18/19/20: 21/21 exit 0; hiçbir dosya yazılmadı |
| 2 | Kontrast: her çift ve 3 hareke tonu × 2 tema ≥ eşik | ✓ | kao-verify-contrast: 328/328 (35 elle seçilmiş + 129 otomatik renk bildirimi × 2 tema), 0 eşik altı; fetha/kesra/damma açık+koyu PASS |
| 3 | Panel: izinli alan dışı anahtar yok; panel/panel-v2 yeşil; kelime düzeyi sızmıyor | ✓ | test_kao_panel_projection.js PASS (9 izinli anahtar, snapshot ve kapsam listesinde lemma/kart kimliği 0); tests/panel 23/23, tests/panel-v2 27/27 |
| 4 | KAO-REGRESYON.md: aile komutları + exit; M7 tavanı açık; R-C9 headless PASS; kalibrasyon 10 bant | ✓ | Aile tablosu komut/dosya/hata/sonuç; fx-coverage exit 1 ve M7 0,60 (eskimiş 0,62 notu) açıkça; R-C9 a/b/c PASS; 10 bant tablosu — denetim hazırlığında 5 banttan 10'a düzeltildi (KAO-20 devam commit'i) |
| 5 | IIP'ye dokunulmadı (archive/ilham-ibadet-premium-plan) | ✓ | Taban 0436405'ten bu yana bu yolu değiştiren tek commit 660dcb2 (IIP'nin kendi 'planı archive/ altına taşı' refactor'u); KAO konulu commit 0 |
...
| Kart | Commit(ler) |
|---|---|
| KAO-18 | `4692e96` KAO-18: devir ve ledger kanıt yolu düzeltmesi<br>`a99077e` KAO-18: kontrast ve erişilebilirlik ölçümü |
| KAO-19 | `9f604a8` KAO-19: panel aynası ve kelime düzeyi sızıntının kapatılması |
| KAO-20 | `be4a2a8` KAO-20: kalibrasyon tablosu 10 bandın tamamını gösterir<br>`0de4d04` KAO-20: tam regresyon, kullanıcı görevleri ve kalibrasyon raporu |
