...
function rootModulesCardHTMLP(){
  ...
  h+='<div class="p3-module"><div class="p3-module-head"><b>Konum zaman ayrımı</b>'+p3StatusP(lt.status||((lt.sampleTs||lt.processedTs)?'ok':'missing'))+stalenessBadgeP(lt.sampleTs||lt.processedTs)+'</div><div class="p3-source-row">'+p3BadgeP('GPS track redacted','privacy')+p3BadgeP('timestamp-only','source')+'</div><div class="p3-kv"><span>Örnek</span><b>'+p3TimeP(lt.sampleTs)+'</b></div><div class="p3-kv"><span>İşlendi</span><b>'+p3TimeP(lt.processedTs)+'</b></div><div class="p3-kv"><span>Uzak kabul</span><b>'+p3TimeP(lt.syncAcceptedAt)+'</b></div></div>';
