...
function settingsProjection(d){
  ...
  return {sourcePath:'data.settings',changedAt:safeIso(root.savedAt),perKeyAudit:false,tracked:{locationEnabled:typeof s.locationEnabled==='boolean'?s.locationEnabled:null,locationMode:safeText(s.locationMode,24),caffeineMode:safeText(s.caffeineMode,24),targetBed:safeText(s.targetBed,8),hideLocationCard:typeof s.hideLocationCard==='boolean'?s.hideLocationCard:null,hideRepoBanner:typeof s.hideRepoBanner==='boolean'?s.hideRepoBanner:null,profileAssessmentInactive:typeof s.profileAssessmentInactive==='boolean'?s.profileAssessmentInactive:null,aeonNotifyPermission:safeText(s.aeonNotifyPermission,24),prayerMethod:safeText(pr.method,24),prayerRemindersEnabled:typeof pr.remindersEnabled==='boolean'?pr.remindersEnabled:null,magnesiumEnabled:typeof mg.enabled==='boolean'?mg.enabled:null,premiumAtmosphere:typeof s.premiumAtmosphere==='boolean'?s.premiumAtmosphere:null,uiSounds:typeof s.uiSounds==='boolean'?s.uiSounds:null,richHaptics:typeof s.richHaptics==='boolean'?s.richHaptics:null,launchRitual:typeof s.launchRitual==='boolean'?s.launchRitual:null,voiceGuidance:typeof s.voiceGuidance==='boolean'?s.voiceGuidance:null,ambientSounds:typeof s.ambientSounds==='boolean'?s.ambientSounds:null,voiceCloudTts:typeof s.voiceCloudTts==='boolean'?s.voiceCloudTts:null},privacy:'preferences_summary'};
}
