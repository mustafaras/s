...
- **Faz 1 devam ediyor.** FX-P-11 tamamlandı (SeyAudio temel UI sesleri). Sıradaki **FX-P-12** (mevcut `zikrTickSound` çağrı noktasını `SeyAudio.tap()` kullanacak şekilde yönlendir — ilk `app.js` değişikliği).
