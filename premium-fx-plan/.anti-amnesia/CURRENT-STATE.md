...
- **Faz 0 devam ediyor.** FX-P-05 tamamlandı (migrate backfill + B1 canlı getter'lar). Sıradaki **FX-P-06** (`mediaFx.js` iskeletini gerçek API yüzeyiyle doldur).
