...
const SW_OFFLINE_VERSION = 'iip22-20260926f';
...
const SW_OFFLINE_MANIFEST = Object.freeze([
  ...
  './app/content/quranLexiconV1.js?v=20260926f',
  './app/content/quranGrammarV1.js?v=20260926f',
  './app/content/quranShortSurahsV1.js?v=20260926f',
  ...
  './app/core/quranLearn.js?v=20260926f',
  ...
  './app/core/messaging.js?v=20260926f',
  './app/core/render.js?v=20260924a',
  './app/core/appSurface.js?v=20260926f',
  './app.js?v=20260926f',
  './sync.js?v=20260926f'
]);
