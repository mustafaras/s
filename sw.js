...
const SW_OFFLINE_VERSION = 'iip22-20260926d';
...
const SW_OFFLINE_MANIFEST = Object.freeze([
  ...
  './app/content/quranLexiconV1.js?v=20260926d',
  './app/content/quranGrammarV1.js?v=20260926d',
  './app/content/quranShortSurahsV1.js?v=20260926d',
  ...
  './app/core/quranLearn.js?v=20260926d',
  ...
  './app/core/messaging.js?v=20260926d',
  './app/core/render.js?v=20260924a',
  './app/core/appSurface.js?v=20260926d',
  './app.js?v=20260926d',
  './sync.js?v=20260926d'
]);
