...
var cssSource=fs.readFileSync(path.join(__dirname,'panel.css'),'utf8');
var htmlSource=fs.readFileSync(path.join(__dirname,'panel.html'),'utf8');
...
var names=['eventStatusP','eventTimeP','safeEventSummaryP','eventSourceKindForP','eventMatchesFilterP','eventFeatureForP','eventJsArgP','eventDrawerFocusableP','eventDrawerKeydownP','setEventFilterP','setEventDrawerLevelP','eventDetailsP','setEventLimitP','openEventDrawerP','closeEventDrawerP','eventLogSourceP','eventLogCardHTMLP'];
