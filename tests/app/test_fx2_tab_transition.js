...
group('FX2-15.7 App yüzeyi 754, onclick 392 ve render/paint gövdeleri değişmedi',
  // IIP-10 / DEC-07: App.saygiLens 718 → 719. IIP-11: App.saygiReader 719 → 720.
  // KAO-14 yüzeyi 730'a çıktı; KAO-15 Seviye 0 dispatcher'ı ekledi. KAO-17 E7 ayarları 734 → 742; KAO-26 stüdyosu 744; KAO-27 gölgeleme 749; KAO-28 âyet 751; KAO-28b harita 752; KAO-16b namaz 754.
  handlers.size === 754 && (combinedSource.match(/onclick=/g) || []).length === 392 &&
