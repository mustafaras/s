...
// KAO-16 okuyucu yüzeyi üç handler ekledi; güncel pin 734 / 392. KAO-17 E7 ayarları sekiz handler ekledi: 742. KAO-26 stüdyosu iki handler: 744. KAO-27 gölgeleme beş handler: 749. KAO-28 âyet iki handler: 751. KAO-28b harita bir handler: 752. KAO-16b namaz iki handler: 754.
group('FX2-10.9 App ve onclick sözleşmesi (FX2-15 + _goTimer)', handlers.size === 754 && count(/onclick=/g, combinedSource) === 392);
