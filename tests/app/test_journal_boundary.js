...
const indexOrder = ['app/core/motivation.js', 'app/core/crisis.js', 'app/core/journal.js', 'app/core/health.js', 'app/core/library.js', 'app/core/mediaFx.js'];
...
ok('index cache-bust ve motivation→crisis→journal→health→mediaFx sırası korunur',
  ...
  indexSource.includes('app/core/journal.js?v=20260909a') && indexSource.includes('app/core/health.js?v=20260910a') && indexSource.includes('app/core/library.js?v=20260910a'));
ok('driver/zikr/state-rebind FILES zincirinde journal ve health vardır',
  ...
  zikrSource.includes("'app/core/health.js'") && rebindSource.includes("'app/core/health.js'") && driverSource.includes("'app/core/library.js'") && zikrSource.includes("'app/core/library.js'") && rebindSource.includes("'app/core/library.js'"));
