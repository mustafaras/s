...
ok('index cache-bust ve motivation→crisis→journal→health→library→report→map→mediaFx sırası korunur',
  ...
  indexSource.includes('app/core/journal.js?v=20260909a') && indexSource.includes('app/core/health.js?v=20260918a') && indexSource.includes('app/core/library.js?v=20260910a') && indexSource.includes('app/core/report.js?v=20260910a') && indexSource.includes('app/core/map.js?v=20260915a'));
