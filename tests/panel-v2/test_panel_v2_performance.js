...
assert(html.includes("panel-v2.css?v=20260824a"), "CSS cache-bust reduced-motion QA sürümüne yükseltildi");
assert(html.includes("panel-v2.js?v=20260812c"), "JS cache-bust final QA sürümüne yükseltildi");
