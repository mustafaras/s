...
var parts=['eventLogSourceP','eventStatusP','eventTimeP','safeEventSummaryP','eventSourceKindForP','eventCategoryDefsP','eventClassificationP','eventPathLabelP','eventOperationLabelP','eventChangeDescriptorP','eventMatchesFilterP','eventFeatureForP','isReminderEventP','reminderEventActionP','reminderEventLabelP','eventDateStateP','eventJsArgP','setEventLimitP','statusToneP','panelStatusBadgeHTMLP','panelLegacyBadgeHTMLP','eventLogCardInnerHTMLP','eventLogCardHTMLP'].map(extractFunction).join('\n');
