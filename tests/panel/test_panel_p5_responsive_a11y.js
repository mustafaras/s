...
var cssSource=fs.readFileSync(path.join(repoRoot,'panel/panel.css'),'utf8');
...
ok('panel HTML cache-bust sürümleri mevcut',/panel\.css\?v=[^"'\s]+/.test(htmlSource)&&/panel\.js\?v=[^"'\s]+/.test(htmlSource));
