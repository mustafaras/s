...
function boot(permission, options) {
  ...
  sandbox.App.start();
  // MON-35: persisted location consent is lazy at boot. Reminder permission
  // assertions need the unlocked app surface, so use the explicit location
  // permission path before exercising notification state.
