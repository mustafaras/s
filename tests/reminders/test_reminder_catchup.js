...
function baseState() {
  return {
    ...
    settings: { nickname: "REM-11 fixture", ghToken: "", ghRepo: "", ghBranch: "", openaiKey: "", profileAssessmentInactive: true, auth: { rememberMe: true, usernameHash: "fixture-auth-hash", unlockedAt: NOW } },
...
function boot(seed) {
  ...
  const sandbox = {
    ...
    navigator: { userAgent: "rem-11-catchup-fixture", vibrate() {}, clipboard: { writeText() { return Promise.resolve(); } }, geolocation: null },
