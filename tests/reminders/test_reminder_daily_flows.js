...
function baseState() {
  return {
    ...
    settings: { nickname: "REM-31 fixture", ghToken: "", ghRepo: "", ghBranch: "", openaiKey: "", profileAssessmentInactive: true, auth: { rememberMe: true, usernameHash: "fixture-auth", unlockedAt: NOW } },
...
function boot() {
  ...
  const sandbox = {
    ...
    navigator: { userAgent: "rem-31-daily-flow-fixture", vibrate() {}, clipboard: { writeText() { return Promise.resolve(); } }, geolocation: null },
