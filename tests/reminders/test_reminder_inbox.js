...
function baseState() {
  return {
    ...
    settings: { nickname: "REM-12 fixture", ghToken: "", ghRepo: "", ghBranch: "", openaiKey: "", profileAssessmentInactive: true,
...
function boot(seed) {
  ...
  const sandbox = {
    ...
    navigator: { vibrate() {}, userAgent: "rem-12-fixture", clipboard: { writeText() { return Promise.resolve(); } }, geolocation: null },
