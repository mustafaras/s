...
function state() {
  return {
    ...
    settings: { nickname: "REM-37 performance fixture", ghToken: "", ghRepo: "", ghBranch: "", openaiKey: "", profileAssessmentInactive: true,
...
function boot() {
  ...
  const sandbox = {
    ...
    navigator: { vibrate() {}, userAgent: "rem-37-performance-fixture", clipboard: { writeText() { return Promise.resolve(); } }, geolocation: null },
