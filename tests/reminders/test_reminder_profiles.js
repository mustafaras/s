...
function baseState(reminders) {
  return {
    ...
    settings: { nickname: "REM-06 fixture", ghToken: "", ghRepo: "", ghBranch: "", openaiKey: "", profileAssessmentInactive: true, auth: { rememberMe: true, usernameHash: "fixture-auth-hash", unlockedAt: "2026-08-13T08:00:00.000Z" } },
...
function boot(seed) {
  ...
  const sandbox = {
    ...
    navigator: { vibrate() {}, userAgent: "rem-06-profile-fixture", clipboard: { writeText() { return Promise.resolve(); } }, geolocation: null },
