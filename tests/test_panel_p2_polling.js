...
var aborted=[];
var ctx={Date:Date,Math:Math,Promise:Promise,String:String,Number:Number,Object:Object,Array:Array,isFinite:isFinite,Error:Error,encodeURIComponent:encodeURIComponent,setTimeout:setTimeout,clearTimeout:clearTimeout,AbortController:AbortController,PANEL_FETCH_TIMEOUT_MS:20000,PANEL_FETCH_ATTEMPTS:3,PANEL_RETRY_DELAY_MS:5,PANEL_TIMEOUT_GROWTH:1.5,PANEL_LAST_DIAG:{status:null,kind:null,attempts:0,at:null,resetAt:null,retryAfterMs:null},parseInt:parseInt,isNaN:isNaN,panelRateInfoP:null,panelRateLimitedP:null,panelNoteDiagP:null,panelAttemptP:null,panelAttemptTimeoutP:null,panelRetryableErrorP:null,PTOKEN:'test-token',PANEL_LATEST_CACHE:{etag:null,sourceRevision:null,sourceUpdatedAt:null},PANEL_POLL_STATE:{conditionalMode:'etag'},responseHeaderP:null,pollConditionalDecisionP:null,panelFetchP:null,fetch:null};
