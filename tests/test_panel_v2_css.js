...
classRule("audit-sequence-card");
classRule("audit-sequence-metrics");
classRule("audit-sequence-issue");
classRule("audit-revision-card");
classRule("audit-revision-row");
classRule("message-summary");
classRule("message-bubble--unread");
classRule("notification-timeline");
classRule("notification-timeline__item--complete");
classRule("notification-timeline__item--current");
classRule("notification-timeline__item--pending");
classRule("message-composer");
classRule("message-composer__input");
classRule("settings-card");
classRule("settings-polling-options");
classRule("settings-choice");
classRule("settings-toggle");
...
assert(js.includes('var swipeEnabled = ui.tab === "day" && mobile;'), "Swipe yalnızca Gün Detayı'nda aktif");
assert(js.includes("var pullEnabled = mobile;"), "Pull-to-refresh mobil touch yüzeyinde aktif");
assert(css.includes(".ae-pull-refresh"), "Pull-to-refresh göstergesi CSS yüzeyi var");
assert(css.includes(".ae-pull-refresh.is-refreshing .ae-pull-refresh__icon"), "Pull-to-refresh spinner animasyonu var");
assert(css.includes("@keyframes aePullSpin"), "Pull-to-refresh dönen animasyon keyframe'i var");
assert(css.includes(".ae-pull-refresh { display: inline-flex; }"), "Pull-to-refresh yalnız mobil breakpoint'te görünür");
